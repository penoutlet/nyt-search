...
5. Create a Node/Express/Handlebars/MongoDB/ReactJS app called `nytreact`. This will be a recreation of the [NYT Articles Search](http://nytarticle-search.herokuapp.com/) exercise application we built back in [Week 6](https://github.com/UCF-Coding-Boot-Camp/01-17-LM-Class-Content/tree/master/Tu-Th-Sat-In-Class-Content/06-ajax/6.3_02.25.2017/05-NYTSearch). Running this application will:
